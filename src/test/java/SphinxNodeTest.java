...
public class SphinxNodeTest {
    ...
    public void processSphinxPacket() throws SphinxException {
        ...
        SphinxHeader inputSphinxHeader = new SphinxHeader(inputAlpha, inputBeta, inputGamma);

        PacketContent inputPacketContent = new PacketContent(inputSphinxHeader, inputDelta);
        ...
        SphinxHeader outputSphinxHeader = outputPacketContent.sphinxHeader();
        ...
        assertEquals(expectedAlpha, outputSphinxHeader.getAlpha());
        assertArrayEquals(expectedBeta, outputSphinxHeader.getBeta());
        assertArrayEquals(expectedGamma, outputSphinxHeader.getGamma());
    ...
    public void processSphinxPacketBadMac() throws SphinxException {
        ...
        SphinxHeader inputSphinxHeader = new SphinxHeader(inputAlpha, inputBeta, badGamma);
