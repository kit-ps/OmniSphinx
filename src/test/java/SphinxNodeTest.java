...
//        ECPoint expectedAlpha = SerializationUtils.decodeECPoint(encodedEcPoint);
//
...
//        Header outputHeader = outputPacketContent.header();
//        byte[] outputDelta = outputPacketContent.delta();
//
